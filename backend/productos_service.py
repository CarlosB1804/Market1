...
def agregar_producto():
    ...
    try:
        ...
        precio = datos.get("precio")  # Corregido
        descripcion = datos.get("descripcion")  # Se agregó para consistencia
        imagen_base64 = datos.get("image")
        
        print("🔍 Datos recibidos en el backend:", nombre, precio, descripcion, imagen_base64) 
